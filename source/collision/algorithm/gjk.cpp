...
namespace Physics2D
{
    ...
    std::tuple<bool, Simplex> GJK::gjk(const ShapePrimitive& shape_A, const ShapePrimitive& shape_B, const size_t& iteration)
    {
        Simplex simplex;
        bool found = false;
    ...
    Simplex GJK::epa(const ShapePrimitive& shape_A, const ShapePrimitive& shape_B, const Simplex& src, const size_t& iteration, const number& epsilon)
    {
        size_t iter = 0;
        Simplex edge;
        Simplex simplex = src;
